<div class="container" style=" width: 850px; margin: 30px auto">
    <div class="row">
        <img src="img/musique_logo.png" align="left" style="background-color: #777777">
    ...
    <div class="row" >
        ...
        <form method="post" action="">
            ...
            <div class="form-group">
                ...
                <input name="email" type="text" class="form-control" style="width: 400px; text-align: left">
            </div>
            <div class="form-group">
                <label>Votre site (falcutatif) </label>
                <input name="site" type="text" required class="form-control" style="width: 400px; text-align: left">
            </div>
            <div class="form-group text-left">
                <label for="comment">Commentaire:</label>
                <textarea class="form-control" rows="5" id="comment" style="width: 400px; height: 200px; text-align: left"></textarea>
            </div>
            <div class="form-group text-left">
                <button type="submit" class="btn btn-primary" style="background-color: chartreuse">
